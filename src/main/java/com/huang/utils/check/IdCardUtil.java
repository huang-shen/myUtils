...
public class IdCardUtil {
    ...
    private final static Hashtable<String, String> AREA_CODE_MAP = new Hashtable<>();
     ...
     * @return 地区
     */
    public String getArea(String idCardNum) {
        return AREA_CODE_MAP.get(idCardNum.substring(0, 2));
    }
    ...
    private static String contertToNewCardNumber(String oldCardNumber) {
        ...
        buf.append(IdCardUtil.calculateVerifyCode(buf));
        return buf.toString();
    }
